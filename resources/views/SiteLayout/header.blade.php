...
<html class="no-js" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/line-icons/2.0.0/line-icons.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/flaticon/5.13.0/font/flaticon.css">
...
<style>
     ...
     .review-card:hover, .review-card2:hover {
       transform: translateY(-10px);
       box-shadow: 0 6px 15px rgba(0, 0, 0, 0.2);
     }
     
     .review-card img, .review-card2 img {
       width: 100%;
       height: 200px;
       object-fit: cover;
       border-bottom: 1px solid #ddd;
     ...
     .review-card h1, .review-card2 h1 {
       font-size: 24px;
       color: #333;
       margin: 15px;
     ...
     .review-card h1:hover, .review-card2 h1:hover {
       color: #305968;
     }
     
     .review-card p, .review-card2 p {
       font-size: 16px;
       color: #555;
       padding: 0 15px;
       margin-bottom: 20px;
     ...
     .review-card a.read-more, .review-card2 a.read-more {
       color: #113954;
       font-weight: bold;
       padding: 10px;
     ...
     .review-card a.read-more:hover, .review-card2 a.read-more:hover {
